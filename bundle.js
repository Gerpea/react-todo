...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Tl": () => (/* binding */ ADD_TODO),
/* harmony export */   "uz": () => (/* binding */ REMOVE_TODO),
/* harmony export */   "zi": () => (/* binding */ MARK_TODO)
/* harmony export */ });
...
/* harmony export */ });
/* unused harmony exports __DO_NOT_USE__ActionTypes, applyMiddleware */
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "todo_app:";
...
var developmentOnly = __webpack_require__(804);
...
;// CONCATENATED MODULE: ./src/state/todos/utils.js
function removeTodo(state, uid) {
  var children = getChildren(state, uid);
  var withoutChild = state;
  children.forEach(function (child) {
    withoutChild = removeTodo(state, child.uid);
  });
  return withoutChild.reduce(function (acc, cur) {
    if (cur.uid !== uid) {
      acc.push(cur);
    }
...
function getParentCount(state, uid) {
  ...
  var parentUid = (_state$find = state.find(function (item) {
    return item.uid === uid;
  })) === null || _state$find === void 0 ? void 0 : _state$find.parentUid;
...
;// CONCATENATED MODULE: ./src/state/todos/reducer.js
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case types/* ADD_TODO */.Tl:
      return [].concat(_toConsumableArray(state), [{
        title: action.payload.title,
        parentUid: getParentCount(state, action.payload.parentUid) < 2 ? action.payload.parentUid : undefined,
        uid: esm_browser_v4(),
        isDone: false
      }]);

    case types/* REMOVE_TODO */.uz:
      return removeTodo(state, action.payload);

    case types/* MARK_TODO */.zi:
...
/* harmony default export */ const reducer = (todosReducer);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[1].use[2]!./node_modules/sass-loader/dist/cjs.js!./src/App.scss
var App = __webpack_require__(748);
...
var TodoList = /*#__PURE__*/react.lazy(_c = function _c() {
  return Promise.all(/* import() */[__webpack_require__.e(994), __webpack_require__.e(42)]).then(__webpack_require__.bind(__webpack_require__, 42));
});
_c2 = TodoList;
var Container = /*#__PURE__*/react.lazy(_c3 = function _c3() {
  return __webpack_require__.e(/* import() */ 682).then(__webpack_require__.bind(__webpack_require__, 682));
});
_c4 = Container;
...
$RefreshReg$(_c, "TodoList$React.lazy");
$RefreshReg$(_c2, "TodoList");
$RefreshReg$(_c3, "Container$React.lazy");
...
var store = (0,redux/* createStore */.MT)(rootReducer, (0,developmentOnly/* devToolsEnhancer */.nR)());

var render = function render(Component) {
  react_dom.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(es/* Provider */.zt, {
    store: store
  }, /*#__PURE__*/react.createElement(Component, null))), document.querySelector('#root'));
};
